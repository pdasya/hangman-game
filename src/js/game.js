import { WORDS, KEYBOARD__LETTERS } from "./consts";
...
const createKeyboard = () => {
  ...
  const keyboardHTML = KEYBOARD__LETTERS.reduce((acc, curr) => {
    return (
      acc +
...
export const startGame = () => {
  ...
  document.getElementById("quit").onclick = () => {
    const isSure = confirm("Are you sure to quit and lose progress?");
    if (isSure) {
      stopGame("quit");
    }
  };
